...
**What is left: the store, and the UI.** Nothing yet opens a document by reference, which is what P5-T11's resolution needs and what "recent files" is a list of. That is the next piece and wants doing with the resolution it unblocks.)*
